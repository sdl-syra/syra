...
class EvaluationsControllerTest < ActionController::TestCase
  ...
  test "should create evaluation" do
    assert_difference('Evaluation.count') do
      post :create, evaluation: { comment: @evaluation.comment, note: @evaluation.note, proposition_id: @evaluation.proposition_id }
    end
  ...
  test "should update evaluation" do
    patch :update, id: @evaluation, evaluation: { comment: @evaluation.comment, note: @evaluation.note, proposition_id: @evaluation.proposition_id }
    assert_redirected_to evaluation_path(assigns(:evaluation))
  end
