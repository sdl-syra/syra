...
class LevelsControllerTest < ActionController::TestCase
  ...
  test "should create level" do
    assert_difference('Level.count') do
      post :create, level: { XPUser: @level.XPUser, levelUser: @level.levelUser, user_id: @level.user_id }
    end
  ...
  test "should update level" do
    patch :update, id: @level, level: { XPUser: @level.XPUser, levelUser: @level.levelUser, user_id: @level.user_id }
    assert_redirected_to level_path(assigns(:level))
  end
