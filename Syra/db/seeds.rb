...
Proposition.create(isPaid: false, isAccepted: nil, motifCancelled: nil, proposition: Time.now, comment: 'Je suis très intéressé !', user_id:user2.id, service_id:s1.id, price:1)
Proposition.create(isPaid: false, isAccepted: nil, motifCancelled: nil, proposition: Time.now, comment: 'Je suis très intéressé !', user_id:user3.id, service_id:s1.id, price:1)
Proposition.create(isPaid: false, isAccepted: nil, motifCancelled: nil, proposition: Time.now, comment: 'Je suis très intéressé !', user_id:user4.id, service_id:s1.id, price:1)
Proposition.create(isPaid: false, isAccepted: nil, motifCancelled: nil, proposition: Time.now, comment: 'Je suis très intéressé !', user_id:user1.id, service_id:s2.id, price:1)
Proposition.create(isPaid: false, isAccepted: nil, motifCancelled: nil, proposition: Time.now, comment: 'Je suis très intéressé !', user_id:user3.id, service_id:s2.id, price:1)
Proposition.create(isPaid: false, isAccepted: nil, motifCancelled: nil, proposition: Time.now, comment: 'Je suis très intéressé !', user_id:user4.id, service_id:s2.id, price:1)
Proposition.create(isPaid: false, isAccepted: nil, motifCancelled: nil, proposition: Time.now, comment: 'Je suis très intéressé !', user_id:user1.id, service_id:s3.id, price:1)
Proposition.create(isPaid: false, isAccepted: nil, motifCancelled: nil, proposition: Time.now, comment: 'Je suis très intéressé !', user_id:user2.id, service_id:s3.id, price:1)
Proposition.create(isPaid: false, isAccepted: nil, motifCancelled: nil, proposition: Time.now, comment: 'Je suis très intéressé !', user_id:user4.id, service_id:s3.id, price:1)
Proposition.create(isPaid: false, isAccepted: nil, motifCancelled: nil, proposition: Time.now, comment: 'Je suis très intéressé !', user_id:user1.id, service_id:s4.id, price:1)
Proposition.create(isPaid: false, isAccepted: nil, motifCancelled: nil, proposition: Time.now, comment: 'Je suis très intéressé !', user_id:user2.id, service_id:s4.id, price:1)
Proposition.create(isPaid: false, isAccepted: nil, motifCancelled: nil, proposition: Time.now, comment: 'Je suis très intéressé !', user_id:user3.id, service_id:s4.id, price:1)
